...
{project-name} is a set of Asciidoctor extensions for converting AsciiDoc documents directly to the FB2 e-book format.

== Introduction

{project-name} is not merely a converter from AsciiDoc to FB2.
